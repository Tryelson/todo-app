                        ...
                        <form action="">
                            <div class="w-[calc(100%-40px)] mx-[auto] flex justify-between gap-[20px]">
                                <div class="flex flex-col gap-[10px] w-[100%] max-w-[260px]">
                                    ...
                                    <input type="text" id="task-name" placeholder="Task name" class="bg-[#2C3440] w-[100%] shadow-md py-[5px] px-[7px] rounded-md outline-none border-[1px] border-[#555C65] focus:shadow-[0px_0px_5px_black]">
                                </div>

                                <div class="flex flex-col gap-[10px] w-[100%] max-w-[260px]">
                                    <label for="select-status" class="text-[#29A19C] font-bold text-[1.25rem]">Status</label>

                                    <select name="" id="" class="bg-[#2C3440] w-[100%] h-[36px] shadow-md py-[5px] px-[7px] rounded-md outline-none border-[1px] border-[#555C65] focus:shadow-[0px_0px_5px_black]">
                                ...
                                <div class="flex flex-col gap-[10px] w-[100%] max-w-[260px]">
                                    ...
                                    <input type="date" id="deadline" class="w-[100%] bg-[#2C3440] shadow-md py-[5px] px-[7px] rounded-md outline-none border-[1px] border-[#555C65] focus:shadow-[0px_0px_5px_black]">
                                </div>
                            </div>
                            ...
                            <div class="w-[calc(100%-40px)] mx-[auto] my-[20px] flex flex-col gap-[30px]">    
                                <div class="flex flex-col gap-[10px]">
                                    ...
                                    <textarea id="description" placeholder="Task description" class="h-[200px] bg-[#2C3440] shadow-md py-[5px] px-[7px] rounded-md outline-none border-[1px] border-[#555C65] focus:shadow-[0px_0px_5px_black]"></textarea>
                                </div>
                                ...
                                <div class="flex justify-end gap-[15px]">
                                    ...
                                    <button type="button" class="bg-[#29A19C] hover:bg-[#2db1ac] uppercase px-[10px] py-[5px] text-[14px] rounded-[5px]">Create task</button>
                                </div>
                            </div>
                        </form>
                    </div>
